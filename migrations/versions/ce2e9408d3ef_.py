...
Revision ID: ce2e9408d3ef
Revises: 
Create Date: 2020-09-27 23:34:58.896056
...
def upgrade():
    ...
    op.create_index(op.f('ix_comment_timestramp'), 'comment', ['timestramp'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_comment_timestramp'), table_name='comment')
