from flask import (
    render_template, Blueprint, request, current_app, flash, redirect, url_for, abort, make_response
)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        if current_app.is_authenticated:
            ...
            flash('Thans, your comment will be published after reviewed.', 'info')
